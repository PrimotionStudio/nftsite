...
<section id="how-we-work" class="tf-box-icon live-auctions home3 bg-style tf-section no-pt-mb">
			...
			<div class="col-md-12">
				<div class="sc-box-icon-inner style2">
					<div class="sc-box-icon">
						...
						<h3 class="heading"><a href="sign-in">Set Up Your Wallet</a></h3>
					...
					<div class="sc-box-icon">
						...
						<h3 class="heading"><a href="sign-in">Create Your Collection</a></h3>
					...
					<div class="sc-box-icon">
						...
						<h3 class="heading"><a href="sign-in">Add Your NFTs</a></h3>
					...
					<div class="sc-box-icon">
						...
						<h3 class="heading"><a href="sign-in">List Them For Sale</a></h3>
